                            ...
                            <form onSubmit={handleGuestStep3} className="space-y-12 animate-in fade-in slide-in-from-bottom-4">
                               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                  ...
                                  <div className="grid grid-cols-2 gap-4 md:col-span-2">
                                     <div className="space-y-2">
                                        <Typography variant="detail" className="text-[10px] uppercase font-black text-slate-400 tracking-widest">Ciudad</Typography>
                                        <input type="text" className="pro-input" required value={guestFormData.city} onChange={(e) => setGuestFormData({...guestFormData, city: e.target.value})} />
                                     </div>
                                     <div className="space-y-2">

                  ...
                  {cartItems.map((item) => (
                     ...
                     >
                      ...
                      <div className="flex-1 space-y-4">
                        ...
                        <div className="flex items-start justify-between sm:justify-start gap-8 sm:gap-16 pt-2">
                          <div className="flex flex-col gap-2">
                            <Typography variant="detail" className="text-[8px] text-slate-300 uppercase tracking-[0.2em] font-black">
                              {item.inventoryQuantity !== undefined
                                ? (item.inventoryQuantity > 0 ? `Disponibilidad: ${item.inventoryQuantity} UNID.` : 'SIN STOCK')
                                : 'Stock'
                              }
                            </Typography>
                          ...
                          <div className="flex flex-col gap-2">
                            <Typography variant="detail" className="text-[8px] text-slate-300 uppercase tracking-[0.2em] font-black">Precio Unitario</Typography>
                            <div className="h-[44px] flex items-center">
                              <Typography variant="h4" className="text-xl font-black">${item.price.toLocaleString()}</Typography>
                            </div>
                          </div>
                        </div>
                      </div>

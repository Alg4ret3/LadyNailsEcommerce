           ...
           <div className="p-8 sm:p-12 md:p-16 space-y-12 bg-white flex flex-col justify-center">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                 <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                       <div className="flex justify-between items-end">
                          ...
                          <Link href="/forgot-password" opacity-40 className="text-[9px] font-black uppercase tracking-widest text-slate-300 hover:text-slate-950 transition-colors">¿Olvidó su clave?</Link>
                       </div>
                       <input 
                         type="password" 
                         required
                 ...
                 <div className="pt-6 space-y-4">
                    <Button type="submit" label={isLoadingState ? "Ingresando..." : "Iniciar Sesión"} className="w-full py-5" />
                    <div className="pt-8 border-t border-slate-50 text-center space-y-4">
                       ...
                       <Link href="/signup" className="block text-center text-[10px] font-black uppercase tracking-widest text-slate-950 hover:underline">Registrarse Aquí</Link>
                    </div>
                 </div>
              </form>
           </div>

    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-44 pb-32 px-6 max-w-[1400px] mx-auto">
        <div className="text-center mb-24 space-y-4">
           ...
           <Typography variant="h1" className="text-5xl md:text-7xl">PREGUNTAS FRECUENTES</Typography>
        </div>
           ...
           {FAQS.map((faq, i) => (
             <div key={i} className="border border-slate-100 bg-slate-50 overflow-hidden">
                <button 
                   ...
                   className="w-full flex items-center justify-between p-8 text-left hover:bg-white transition-all bg-white"
                >
                   <Typography variant="h4" className="text-lg tracking-tight normal-case">{faq.q}</Typography>

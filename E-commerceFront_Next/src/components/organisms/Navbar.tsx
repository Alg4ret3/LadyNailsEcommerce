    ...
    return (
      ...
      >
        <Link
          ...
          className={`flex items-center justify-between px-6 py-2.5 text-[11px] font-bold uppercase tracking-widest transition-all ${activeHoverCategory?.id === category.id
                ...
                {activeDropdown === "catalogo" && (
                  ...
                  >
                    ...
                    {activeHoverCategory && activeHoverCategory.category_children && activeHoverCategory.category_children.length > 0 && (
                      <div className="w-[280px] py-4 max-h-[65vh] overflow-y-auto overflow-x-hidden custom-scrollbar bg-white">
                        <Typography
                          variant="detail"
